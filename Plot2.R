...
TotalPM<-aggregate(baltimorePM5$Emissions,by=list(baltimorePM5$year),sum)
...
axis(side=2,at=c(TotalPM$TotalEmissions),labels=c("3274","2453","3091","1862"),las=1,cex=.5)  
title(main="Total PM5 Emisisons across years for Baltimore City", col.main="red",
      xlab="Year", ylab="Total PM5 ror Baltimore City",
      col.lab="blue")
dev.off()
